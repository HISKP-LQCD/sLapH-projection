...
################################################################################
# T1
T1_1 = [[np.asarray([ 1,  0,  0], dtype=int),[np.asarray([-1,  0,  0], dtype=int), -1./2], \
...
T1_2 = [[np.asarray([ 1,  0,  0], dtype=int),[np.asarray([-1,  0,  0], dtype=int),  0.], \
...
T1_3 = [[np.asarray([ 1,  0,  0], dtype=int),[np.asarray([-1,  0,  0], dtype=int),  1./2], \
        [np.asarray([ 0,  1,  0], dtype=int),[np.asarray([ 0, -1,  0], dtype=int),      -1j/2], \
        [np.asarray([ 0,  0,  1], dtype=int),[np.asarray([ 0,  0, -1], dtype=int),  0.], \
        [np.asarray([-1,  0,  0], dtype=int),[np.asarray([ 1,  0,  0], dtype=int), -1./2], \
        [np.asarray([ 0, -1,  0], dtype=int),[np.asarray([ 0,  1,  0], dtype=int),       1j/2], \
