# TODO: Implement logic to automatically create filenames and folders e.g.
# with regex and os.walk
    ...
    for name in nametags:
        ...
        for p in momenta:
            ...
            for irrep in irreps:
                ...
                try:
                    checks.append(compare_files(
                        [path1 + filename, path2 + filename], ['data', 'data']))
                except ValueError:
                    checks.append(False)
