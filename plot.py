...
def plot_sep_rows_avg_mom(subduced_data, diagram, pdfplot):
...
for diagram in ['C2', 'C3', 'C4']:
  ...
  plot_path = './plots/%s_p%1i_%s.pdf' % (diagram, p_cm, irrep)
  pdfplot = PdfPages(plot_path)
  plot_sep_rows_avg_mom(subduced_data, diagram, pdfplot)
  pdfplot.close()
